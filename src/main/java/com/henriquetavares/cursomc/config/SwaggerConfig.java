...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.henriquetavares.cursomc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                new Contact("Henrique Tavares", "github.com/tavareshenrique", "ihenrits@gmail.com"),
